...
def generate_account(w3):
    ...
    account = Account.privateKeyToAccount("5f88fbba6ec7da124de75ef9d552d78efec70e5753d580b26666b49d487d660f")
...
def send_transaction(w3, account, receiver, wage):
    ...
    raw_tx = {
        ...
        "value": wei_value,
        "gas": gas_estimate, #how many liters
        "gasPrice": 0, # price per liter
